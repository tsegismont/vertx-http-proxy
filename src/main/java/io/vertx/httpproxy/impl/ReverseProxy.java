...
public class ReverseProxy implements HttpProxy {
  ...
  private OriginRequestProvider originRequestProvider = (pc, client) -> Future.failedFuture("No origin available");
  ...
  private Future<HttpClientRequest> resolveOrigin(ProxyContext proxyContext) {
    return originRequestProvider.create(proxyContext, client);
  }
